    ...
    <div v-if="selectedGuild" class="bg-gray-900/50 border border-gray-800 rounded-lg p-4 sm:p-6">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div class="flex items-center gap-4">
          ...
          <button @click="importFromQuestlog" :disabled="isImporting" class="bg-indigo-900/50 hover:bg-indigo-800 disabled:opacity-50 disabled:cursor-not-allowed text-indigo-300 text-xs font-bold py-1.5 px-3 rounded border border-indigo-700 transition-colors flex items-center gap-2">
      ...
      <div class="mt-8 flex flex-col sm:flex-row justify-end gap-4 border-t border-gray-800 pt-6">
        ...
        <button @click="submitBuild" class="neon-btn-primary px-8 w-full sm:w-auto">
