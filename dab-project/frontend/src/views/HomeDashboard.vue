...
<template>
  <div class="p-4 md:p-8 max-w-6xl mx-auto animate-fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
      ...
      <router-link to="/activity" class="glass-panel p-6 rounded-xl hover:border-blue-500 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all cursor-pointer group flex flex-col items-center text-center">
        ...
        <h3 class="font-rajdhani text-xl font-bold text-gray-200 uppercase tracking-wide">{{ t('dashboard.activityTitle') }}</h3>
        <p class="text-sm text-gray-500 font-mono mt-2">{{ t('dashboard.activityDesc') }}</p>
      </router-link>
    </div>
