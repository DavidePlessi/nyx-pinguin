...
async def init_db():
    ...
    await init_beanie(database=database, document_models=[GuildConfig, AdminUser, BotLog, GuildMusicStatus, ApiInstances, DropUser, Build, DropHistory, DropPoll, WeaponClassMapping])
